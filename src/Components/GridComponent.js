  ...
  return (
    <div className={classes.root}>
      ...
      <Grid item xs={12} lg={4} style={{padding:'30px 0px'}}>
          ...
          <div>
              <div className="header-text-font-result">OPENNESS (O)</div>
        ...
        <Grid item xs={12} lg={4} style={{padding:'30px 0px'}}>
          <Paper className={classes.paper} elevation={18}>
              <div>
              <div className="header-text-font-result">CONSCIENTIOUSNESS (C)</div>
        ...
        <Grid item xs={12} lg={4} style={{padding:'30px 0px'}}>
          <Paper className={classes.paper} elevation={18}>  
            <div>
              <div className="header-text-font-result">EXTROVERSION (E)</div>
        ...
        <Grid item xs={12} lg={4} style={{padding:'30px 0px'}}>
          <Paper className={classes.paper} elevation={18}>
          <div>
              <div className="header-text-font-result">AGREEABLENESS (A)</div>
        ...
        <Grid item xs={12} lg={4} style={{padding:'30px 0px'}}>
          <Paper className={classes.paper} elevation={18}>
          <div>
              <div className="header-text-font-result">NEUROTICISM (N)</div>
